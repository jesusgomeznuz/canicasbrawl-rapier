//! LA VIDA DEL JUEGO: run() y sus tres fases — nacer, el loop central, morir.
//! En `--write-timeline` este MISMO flujo corre headless y el engine lo
//! fotografía: este juego se escribe jugándose a sí mismo.
...
use super::{race, race_events, scene, world};
use super::race::roster::MarbleConfig;
use super::scene::background::palette::ColorPalette;
